              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  <p className='text-muted-foreground'>
                    ...
                    modern JavaScript frameworks. My expertise spans from
                    building scalable client-facing applications to dynamic user
                    onboarding systems for banking and fintech companies.
                  </p>

                  <p className='text-muted-foreground'>
                    I'm passionate about staying current with the latest
                    technologies and best practices, recently mastering Nuxt 3
                    and TypeScript while maintaining strong expertise in React
                    and Vue.js ecosystems.
                  </p>
      ...
      <section id='experience' className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
              Building exceptional products across fintech, banking, and legal
              tech
            </p>
          </motion.div>
